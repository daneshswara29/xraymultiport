...
NC='\e[0m'
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/daneshswara29/xraymultiport/main"
clear
if [[ -e /usr/local/bin/xray ]]; then
	 ...
	 wget -O add-tr "https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/XRAY/add-tr.sh" && chmod +x add-tr
	 wget -O add-vless "https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/XRAY/add-vless.sh" && chmod +x add-vless
	 wget -O add-ws "https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/XRAY/add-ws.sh" && chmod +x add-ws
	 wget -O user-tr "https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/XRAY/user-tr.sh" && chmod +x user-tr
	 wget -O user-vless "https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/XRAY/user-vless.sh" && chmod +x user-vless
	 ...
	 sleep 1
	 rm -rf /usr/local/sbin/helium
	 wget -q -O /usr/local/sbin/helium https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/helium.sh
	 cd /usr/bin
	 rm nf
	 rm ins-helium
	 rm limit
