...
wget -O /usr/local/bin/xray "https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/xray.linux.64bit"
chmod +x /usr/local/bin/xray

# generate certificates
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/acme.sh -o /root/.acme.sh/acme.sh
...
Documentation=https://Daneshswara-Project.net https://github.com/XTLS/Xray-core
