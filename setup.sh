...
clear
#echo -e "${red}♦️${NC} ${green}Established By DANESHSWARA 2022${NC} ${red}♦️${NC}"
...
#wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/daneshswara29/xraymultiport/main/OTHERS/index.html"
...
echo -e "${RB}      '-------------------------------------------'${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "      ${WB}Multiport Websocket Autoscript By DANESHSWARA${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
...
echo -e ""
echo -e "  ${RB}♦️${NC} ${YB}Autoreboot On 06.00 GMT +7${NC}"
