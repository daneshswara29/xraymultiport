...
organization="Daneshswara-Project"
organizationalunit="Daneshswara-Project"
commonname="Daneshswara-Project"
email="daneshswara2@gmail.com"
...
wget https://github.com/daneshswara29/vnstat/releases/download/vnstat2.6/vnstat-2.6.tar.gz
